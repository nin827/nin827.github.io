...
> 
> <i class="small">importance 3 — … category</i>
{ #profile}
...
Few first cities that android lives in include [[MATERIAL/_REWORK/ARTICLEx/AR002\|Bangkok]], Tokyo, Shenzhen, Berlin, San Francisco — initially only living in closed-off buildings, then eventually to be free to explore after late 2080s.
