...
>[!empty]
> ![RESOURCE/ASSET/OTHER/PlaceholderIcon.png|icon](/img/user/RESOURCE/ASSET/OTHER/PlaceholderIcon.png) <u class="title">Material Categories</u> <sup class="title">NO0004</sup>
...
| Moment   |                                                                           | As **current**\* event and happening     |                                                                                      |                                                                                                                                         |
| Dump     |                                                                           | As **omniscient**\* note and remarks     |                                                                                      |                                                                                                                                         |
...
```mermaid
%%{init: {'theme': 'neutral', 'themeVariables': {'fontSize': '--font-text-size', 'fontFamily': '--font-text-theme'}}}%%
