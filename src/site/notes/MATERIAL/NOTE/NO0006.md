...
>[!empty]
> ![RESOURCE/ASSET/OTHER/PlaceholderIcon.png|icon](/img/user/RESOURCE/ASSET/OTHER/PlaceholderIcon.png) <u class="title">Nin's Formatting Style</u> <sup class="title">NO0006</sup> <sub class="title"> </sub>
