...
- The main identity theme of [[SPECIAL/SP_NS22\|Project NS22]] is mecha & technology (as well as soft sci-fi, near future, and bits of sci-fi), particularly "robots as human equal" concept — yet it is rated moderately on average, yet very polarized between those who prefer and not prefer towards it.
...
- Key takeaway is the [[SPECIAL/SP_NS22\|Project NS22]] is going to target and satisfy a specific niche, considering that the key-defining "robots as human equal" is not rated so high in general, but rated quite moderate among those who are inclined towards mecha & technology.
